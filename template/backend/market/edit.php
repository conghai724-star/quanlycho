    ...
    <div class="card">
        <div class="card-header" style="border-bottom: 1px solid var(--border-color); padding: 20px 24px;">
            <h2 class="card-title" style="font-size: 18px; font-weight: 600; margin: 0; color: var(--text-heading);">
                ...
                Sửa Thông Tin Chợ: <?php echo htmlspecialchars($market['name']); ?>
            </h2>
        </div>
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>system/market_edit/<?php echo $market['id']; ?>">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" required value="<?php echo htmlspecialchars($market['name']); ?>" style="width: 100%; padding: 8px 12px; border: 1px solid var(--border-color); border-radius: 6px; font-size: 14px;">
                    </div>
                    <!-- Mã chợ -->
                    <div>
                        ...
                        <input type="text" name="market_code" required value="<?php echo htmlspecialchars($market['market_code']); ?>" style="width: 100%; padding: 8px 12px; border: 1px solid var(--border-color); border-radius: 6px; font-size: 14px; text-transform: uppercase;">
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" value="<?php echo htmlspecialchars($market['phone'] ?? ''); ?>" style="width: 100%; padding: 8px 12px; border: 1px solid var(--border-color); border-radius: 6px; font-size: 14px;">
                    </div>
                    <!-- Email -->
                    <div>
                        <label style="display: block; font-weight: 500; font-size: 13.5px; margin-bottom: 6px; color: var(--text-heading);">Email liên hệ</label>
                        <input type="email" name="email" value="<?php echo htmlspecialchars($market['email'] ?? ''); ?>" style="width: 100%; padding: 8px 12px; border: 1px solid var(--border-color); border-radius: 6px; font-size: 14px;">
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 24px;">
                    ...
                    <div>
                        ...
                        <input type="text" name="manager_name" value="<?php echo htmlspecialchars($market['manager_name'] ?? ''); ?>" style="width: 100%; padding: 8px 12px; border: 1px solid var(--border-color); border-radius: 6px; font-size: 14px;">
                    </div>
                    <!-- Trạng thái -->
                    <div>
