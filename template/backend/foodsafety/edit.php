            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-bottom: 20px;">
                ...
                <div class="form-group">
                    ...
                    <select id="doc_type" name="doc_type" class="form-control" required>
                        ...
                        <option value="ATTP" <?php echo $certificate['doc_type'] === 'ATTP' ? 'selected' : ''; ?>>Giấy chứng nhận cơ sở đủ điều kiện ATTP</option>
                        <option value="Health" <?php echo $certificate['doc_type'] === 'Health' ? 'selected' : ''; ?>>Giấy khám sức khỏe định kỳ</option>
                        <option value="Training" <?php echo $certificate['doc_type'] === 'Training' ? 'selected' : ''; ?>>Giấy xác nhận tập huấn kiến thức ATTP</option>
                    </select>
                </div>
            </div>
