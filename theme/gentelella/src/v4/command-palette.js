...
function buildItems() {
  ...
  const actions = [
    ...
    { label: 'Open profile', keywords: 'profile account user me', action: () => { window.location.href = (window.BASE_URL || '/') + 'admin/users'; } },
    { label: 'Open settings', keywords: 'settings preferences config', action: () => { window.location.href = (window.BASE_URL || '/') + 'admin/theme'; } },
    { label: 'Theme generator', keywords: 'theme color customize brand', action: () => { window.location.href = (window.BASE_URL || '/') + 'admin/theme'; } },
    { label: 'Help & support', keywords: 'help faq support docs', action: () => { window.location.href = (window.BASE_URL || '/') + 'admin/theme'; } },
    {
      label: 'Sign out',
      ...
      action: () => showModal({
        ...
        actions: [
          ...
          { label: 'Sign out', variant: 'primary', action: () => {
            ...
            setTimeout(() => { window.location.href = (window.BASE_URL || '/') + 'home/logout'; }, 600);
          } }
        ]
      })
    }
