...
const USER_MENU = [
  { label: 'Profile',            action: () => { window.location.href = (window.BASE_URL || '/') + 'admin/users'; } },
  { label: 'Account settings',   action: () => { window.location.href = (window.BASE_URL || '/') + 'admin/theme'; } },
  { label: 'Theme generator',    action: () => { window.location.href = (window.BASE_URL || '/') + 'admin/theme'; } },
  { label: 'Keyboard shortcuts', action: openShortcutsModal },
  '-',
  { label: 'Help & support',     action: () => { window.location.href = (window.BASE_URL || '/') + 'admin/theme'; } },
  { label: 'Lock screen',        action: () => { window.location.href = (window.BASE_URL || '/') + 'home/logout'; } },
